...
export class RegisterComponent {
  ...
  register() {
    if (!this.usuario.trim() || !this.contrasena.trim() || !this.repeatContrasena.trim() || !this.nombre.trim() || !this.apellidos.trim() || !this.email.trim() || !this.edad.trim() || !this.sexo.trim() || !this.piso.trim() || !this.ciudad.trim() || !this.situacion.trim()) {
